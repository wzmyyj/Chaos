 ...
 * @since 1.0.0
 */
fun Float.sp2px(context: Context = FeApp.get()): Int {
    return DimensionUtil.sp2px(context, this)
}

fun Float.dp2px(context: Context = FeApp.get()): Int {
    return DimensionUtil.dp2px(context, this)
}

fun Float.pt2px(context: Context = FeApp.get()): Int {
    return DimensionUtil.pt2px(context, this)
}

fun Int.px2sp(context: Context = FeApp.get()): Float {
    return DimensionUtil.px2sp(context, this)
}

fun Int.px2dp(context: Context = FeApp.get()): Float {
    return DimensionUtil.px2dp(context, this)
}

fun Int.px2pt(context: Context = FeApp.get()): Float {
